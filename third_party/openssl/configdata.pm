...
our %config = (
  ...
  CFLAGS => [ "-arch i386", "-openssldir=/Users/erika/projects/objc/twitterapp/DerivedData/twitterapp/Build/Products" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXXFLAGS => [ "-openssldir=/Users/erika/projects/objc/twitterapp/DerivedData/twitterapp/Build/Products" ],
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "Configurations/00-base-templates.conf", "Configurations/10-main.conf", "Configurations/15-ios.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)xcrun -sdk iphonesimulator cc",
  minor => "1.1",
...
our %target = (
  ...
  RANLIB => "ranlib -c",
  RC => "windres",
  _conf_fname_int => [ "Configurations/00-base-templates.conf", "Configurations/00-base-templates.conf", "Configurations/10-main.conf", "Configurations/15-ios.conf", "Configurations/15-ios.conf", "Configurations/shared-info.pl" ],
